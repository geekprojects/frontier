...
public:
  ...
  virtual void enterAtKeyword(css3Parser::AtKeywordContext *ctx) = 0;
  virtual void exitAtKeyword(css3Parser::AtKeywordContext *ctx) = 0;
  ...
  virtual void enterKeyframesBlocks(css3Parser::KeyframesBlocksContext *ctx) = 0;
  virtual void exitKeyframesBlocks(css3Parser::KeyframesBlocksContext *ctx) = 0;
